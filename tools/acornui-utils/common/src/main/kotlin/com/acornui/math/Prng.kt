 ...
 */
open class Prng(var seed0: Long = 0, var seed1: Long = 0) {
 ...
 */
fun Prng.random(start: Int, end: Int): Int {
 ...
 * Returns a random number between 0 (inclusive) and the specified value (inclusive).
 */
fun Prng.random(range: Long): Long {
 ...
 * Returns a random number between start (inclusive) and end (inclusive).
 */
fun Prng.random(start: Long, end: Long): Long {
 ...
 */
fun Prng.randomBoolean(chance: Float): Boolean {
 ...
 */
fun Prng.random(range: Float): Float {
 ...
 */
fun Prng.random(start: Float, end: Float): Float {
 ...
 */
fun Prng.randomTriangular(): Float {
 ...
 */
fun Prng.randomTriangular(max: Float): Float {
 ...
 * @param max the upper limit
 */
fun Prng.randomTriangular(min: Float, max: Float): Float {
 ...
 */
fun Prng.randomTriangular(min: Float, max: Float, mode: Float): Float {
	val u = nextFloat()
	val d = max - min

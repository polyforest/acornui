 ...
 * @author nbilyk
 */
class ArrayListBuffer<T>(private val array: MutableList<T>, private val arrayOffset:Int = 0, capacity:Int = Int.MAX_VALUE) : BufferBase<T>(capacity), ReadWriteBuffer<T> {

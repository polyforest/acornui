...
import com.acornui.core.input.interaction.LongPressAttachment.Companion.DEFAULT_LONG_PRESS_TIME
import com.acornui.core.input.touchEnd
import com.acornui.core.input.touchMove
...
private class LongPressAttachment(
	...
	private fun touchStartHandler(event: TouchInteractionRo) {
		...
		timerRef = target.timer(longPressTime, callback = ::timerHandler)
	}

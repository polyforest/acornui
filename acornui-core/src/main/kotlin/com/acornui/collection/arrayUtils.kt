...
fun DoubleArray.fill2(element: Double, fromIndex: Int = 0, toIndex: Int = size): Unit {
	for (i in fromIndex until toIndex) {
		this[i] = element
	}
}

fun DoubleArray.scl(scalar: Double) {
 ...
 */
fun DoubleArray.add(index: Int, elements: DoubleArray): DoubleArray {
	val newArr = DoubleArray(size + elements.size)
 ...
 */
fun DoubleArray.remove(index: Int, count: Int): DoubleArray {
	val newArr = DoubleArray(size - count)
	copyInto(newArr, 0, 0, index)
 ...
 */
fun DoubleArray.getInsertionIndex(element: Double, stride: Int = 1, offset: Int = 0, fromIndex: Int = 0, toIndex: Int = size): Int {

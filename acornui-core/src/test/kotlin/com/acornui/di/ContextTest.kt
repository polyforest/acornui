...
class ContextTest {
	...
	private val keyWithFactoryApp1 = object : Context.Key<Double> {
		var constructCount = 0
	...
	private val keyWithFactoryApp2 = object : Context.Key<Double> {
		var constructCount = 0
		override val factory = dependencyFactory(ContextMarker.APPLICATION) {
			++constructCount
			2.0
	...
	@Test fun keysWithFactory() {
		...
		assertEquals(1.0, appContext1.inject(keyWithFactoryApp1))
		assertEquals(1.0, appContext1.inject(keyWithFactoryApp1))
		assertEquals(1.0, appContext2.inject(keyWithFactoryApp1))
		assertEquals(1.0, appContext2.inject(keyWithFactoryApp1))
		assertEquals(2.0, appContext1.inject(keyWithFactoryApp2))
		assertEquals(2.0, appContext2.inject(keyWithFactoryApp2))

...
abstract class FloatColumn<in E> : DataGridColumn<E, Double?>() {
	...
	override fun createCell(owner: Context): DataGridCell<Double?> = NumberCell(owner, formatter)
	override fun createEditorCell(owner: Context): DataGridEditorCell<Double?> = FloatEditorCell(owner)
...
class FloatEditorCell(owner: Context) : NumberEditorCell(owner), DataGridEditorCell<Double?> {

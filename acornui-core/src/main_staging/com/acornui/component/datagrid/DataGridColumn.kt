...
abstract class DataGridColumn<in RowData, CellData> : ObservableBase() {
	...
	var width: Double? by watched(null)
	var widthPercent: Double? by watched(null)
	var minWidth: Double by watched(8.0)
	...
	fun getPreferredWidth(availableWidth: Double?): Double? {

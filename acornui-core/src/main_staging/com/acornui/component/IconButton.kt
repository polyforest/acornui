...
inline fun Context.iconButton(atlasPath: String, region: String, init: ComponentInit<IconButton> = {}): IconButton =
		iconButton(mapOf(1.0 to atlasPath), region, init)

inline fun Context.iconButton(atlasPaths: Map<Double, String>, region: String, init: ComponentInit<IconButton> = {}): IconButton {
	contract { callsInPlace(init, InvocationKind.EXACTLY_ONCE) }
	val button = IconButton(this).apply {
...
inline fun Context.iconButton(atlasPath: String, regions: Map<ButtonState, String>, init: ComponentInit<IconButton> = {}): IconButton =
		iconButton(mapOf(1.0 to atlasPath), regions, init)

inline fun Context.iconButton(atlasPaths: Map<Double, String>, regions: Map<ButtonState, String>, init: ComponentInit<IconButton> = {}): IconButton {
	contract { callsInPlace(init, InvocationKind.EXACTLY_ONCE) }
	val b = IconButton(this)

...
interface VirtualLayoutAlgorithm<in S, out T : LayoutData> : LayoutDataProvider<T> {
	 ...
	 * @return
	 */
	fun getOffset(width: Double, height: Double, element: LayoutElementRo, index: Int, lastIndex: Int, isReversed: Boolean, props: S): Double
	 ...
	 */
	fun updateLayoutEntry(explicitWidth: Double?, explicitHeight: Double?, element: LayoutElement, currentIndex: Int, startIndex: Double, lastIndex: Int, previousElement: LayoutElementRo?, isReversed: Boolean, props: S)
	 ...
	 */
	fun measure(explicitWidth: Double?, explicitHeight: Double?, elements: List<LayoutElementRo>, props: S, out: Bounds) {
	 ...
	 */
	fun shouldShowRenderer(explicitWidth: Double?, explicitHeight: Double?, element: LayoutElementRo, props: S): Boolean
...
interface ItemRendererContext<out T : LayoutData> : Context, LayoutDataProvider<T>

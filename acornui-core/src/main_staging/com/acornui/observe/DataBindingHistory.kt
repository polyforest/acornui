...
class DataBindingHistory<T>(
	...
	private val delayedPush = delayedCallback(host.inject(frameDriverKey), 0.7, ::pushState)
...
fun <T> UiComponent.applyDataBindingUndoRedo(dataBinding: DataBinding<T>, init: ComponentInit<DataBindingHistory<T>> = {}): DataBindingHistory<T> {

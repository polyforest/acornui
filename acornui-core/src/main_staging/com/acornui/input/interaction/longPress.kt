...
private class LongPressAttachment(
		...
		private val affordance: Double = DragAttachment.DEFAULT_AFFORDANCE
) : ContextImpl(target) {
	...
	private var startCanvasX: Double = -9999.0
	private var startCanvasY: Double = -9999.0
 ...
 *
 */
fun UiComponent.longPress(
		isCapture: Boolean = false,
		longPressTime: Duration = DEFAULT_LONG_PRESS_TIME,
		affordance: Double = DragAttachment.DEFAULT_AFFORDANCE
): Signal<() -> Unit> {

 ...
 */
fun UiComponent.rollOver(isCapture: Boolean = false): StoppableSignal<MouseEventRo> {
	return createOrReuseAttachment("MouseOverChanged_$isCapture") {
		RollOverAttachment(this, isCapture = isCapture)
	}.over
}

fun UiComponent.rollOut(isCapture: Boolean = false): StoppableSignal<MouseEventRo> {
	return createOrReuseAttachment("MouseOverChanged_$isCapture") {
		RollOverAttachment(this, isCapture = isCapture)
	}.out
}

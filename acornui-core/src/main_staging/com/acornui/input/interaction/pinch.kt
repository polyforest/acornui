...
interface PinchEventRo : EventRo {
	...
	val startMidpoint: Vector2Ro
		get() = (startPoints.second + startPoints.first) * 0.5
	...
	val midpoint: Vector2Ro
		get() = (points.second + points.first) * 0.5
	/**
...
class PinchAttachment(
	...
	companion object {
		 ...
		 */
		const val DEFAULT_AFFORDANCE: Double = 5.0
	}
}

@ExperimentalAcorn
fun UiComponent.pinchAttachment(affordance: Double = PinchAttachment.DEFAULT_AFFORDANCE): PinchAttachment {
 ...
 */
@ExperimentalAcorn
fun UiComponent.pinchStart(): Signal<PinchEventRo> {
 ...
 */
@ExperimentalAcorn
fun UiComponent.pinch(): Signal<PinchEventRo> {
 ...
 */
@ExperimentalAcorn
fun UiComponent.pinchEnd(): Signal<PinchEventRo> {
